...
class Var(object):
    ...
    BIN_CHANNEL = int(getenv('BIN_CHANNEL', '-1001772483197'))
    ...
    DATABASE_URL = str(getenv('DATABASE_URL', 'mongodb+srv://ALLU:<password>@cluster0.5blb9tp.mongodb.net/?retryWrites=true&w=majority'))
